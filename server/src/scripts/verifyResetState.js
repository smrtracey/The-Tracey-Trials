...
async function verifyResetState() {
  ...
  const usersWithJudgeAdjustmentPoints = await User.countDocuments({ judgeAdjustmentPoints: { $ne: 0 } })
  ...
  console.log(`usersWithJudgeAdjustmentPoints=${usersWithJudgeAdjustmentPoints}`)
